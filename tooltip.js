...
jQuery('.stripe_product_amount').keypress(function(){
  if(jQuery(this).val()==''){
    jQuery(this).prev('.currency').fadeIn();
    }
});

jQuery('.stripe_product_amount').blur(function(){
  if(jQuery(this).val()==''){
    jQuery(this).prev('.currency').fadeOut();
    }
});
