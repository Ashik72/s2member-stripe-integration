...
class Stripe_Customer2 extends Stripe_ApiResource2
{
  /**
  ...
  public function addInvoiceItem($params=null)
  {
    ...
    $ii = Stripe_InvoiceItem2::create($params, $this->_apiKey);
    return $ii;
  }
  ...
  public function invoices($params=null)
  {
    if (!$params)
      $params = array();
    $params['customer'] = $this->id;
    $invoices = Stripe_Invoice2::all($params, $this->_apiKey);
    return $invoices;
  }
  ...
  public function invoiceItems($params=null)
  {
    if (!$params)
      $params = array();
    $params['customer'] = $this->id;
    $iis = Stripe_InvoiceItem2::all($params, $this->_apiKey);
    return $iis;
  }
  ...
  public function charges($params=null)
  {
    if (!$params)
      $params = array();
    $params['customer'] = $this->id;
    $charges = Stripe_Charge2::all($params, $this->_apiKey);
    return $charges;
  }
