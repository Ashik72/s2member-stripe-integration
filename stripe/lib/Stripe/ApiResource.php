...
abstract class Stripe_ApiResource2 extends Stripe_Object2
{
    ...
    /**
     * @returns Stripe_ApiResource2 The refreshed resource.
     */
    ...
    public function instanceUrl()
    {
        ...
        if (!$id) {
            ...
            throw new Stripe_InvalidRequestError2($message, null);
        }
    ...
    private static function _validateCall($method, $params = null, $apiKey = null)
    {
        if ($params && !is_array($params)) {
            ...
            throw new Stripe_Error2($message);
        }

        if ($apiKey && !is_string($apiKey)) {
            $message = 'The second argument to Stripe API method calls is an '
                . 'optional per-request apiKey, which must be a string.  ' . '(HINT: you can set a global apiKey by '
                . '"Stripe2::setApiKey(<apiKey>)")';
            throw new Stripe_Error2($message);
        }
    }
    ...
    protected static function _scopedAll($class, $params = null, $apiKey = null)
    {
        ...
        $requestor = new Stripe_ApiRequestor2($apiKey);
